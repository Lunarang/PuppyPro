...
Dog.create(name: "Dodger", sex: "Female", dob: "2019-11-30", user_id: "#{erin.id}")
Dog.create(name: "Buccaroo", sex: "Male", dob: "2020-08-26", user_id: "#{steve.id}")
Dog.create(name: "Goose", sex: "Male", dob: "2015-02-03", user_id: "#{mel.id}")